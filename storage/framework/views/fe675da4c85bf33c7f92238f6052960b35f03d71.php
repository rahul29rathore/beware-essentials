    ...
    <div class="container">
        <div class="row pt-0">
            ...
            <div class="col-lg-12 mb-5">
                <img src="<?php echo e(asset('assets/images/collarge.png')); ?>" class="img-fluid" alt="">
            </div>
            <div class="wpb_wrapper row m-0">
                    ...
                    <div class="ult-item-wrap p-3 br-20" data-aos="fade-up" data-aos-delay="300" data-animation="animated no-animation">
                        <div class="dt-sc-icon-box type4 ">
                            <div class="icon-wrapper">
                                <img width="75" height="75" src="<?php echo e(asset('assets/images/mission.png')); ?>" class="attachment-full" alt="">
                            </div>
                ...
                <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12 d-none d-lg-block" data-aos="fade-up" data-aos-delay="800">
                    <img src="<?php echo e(asset('assets/images/dome-camera.png')); ?>" class="dome-cam-img" alt="">
                </div>
                <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12 mb-3">
                    <div class="ult-item-wrap p-3 br-20" data-aos="fade-up" data-aos-delay="300" data-animation="animated no-animation">
                        <div class="dt-sc-icon-box type4 ">
                            <div class="icon-wrapper">
                                <img width="75" height="75" src="<?php echo e(asset('assets/images/vision.png')); ?>" class="attachment-full" alt="">
                            </div>
                            <div class="icon-content">
                ...
                <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12 mb-3">
                    <div class="ult-item-wrap p-3 br-20" data-aos="fade-up" data-aos-delay="300" data-animation="animated no-animation">
                        <div class="dt-sc-icon-box type4 ">
                            <div class="icon-wrapper">
                                <img width="75" height="75" src="<?php echo e(asset('assets/images/quality.png')); ?>" class="attachment-full" alt="">
                            </div>
                            <div class="icon-content">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\beware-essentials\resources\views/pages/about-us.blade.php ENDPATH**/ ?>