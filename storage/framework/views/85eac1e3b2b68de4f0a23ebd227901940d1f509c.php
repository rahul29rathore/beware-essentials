...
<?php $__env->startSection('title'); ?> beware-essentials.com <?php $__env->stopSection(); ?>
<?php $__env->startSection('meta_description'); ?> index title <?php $__env->stopSection(); ?>
<?php $__env->startSection('meta_keywords'); ?>
beware, camera, security, security-products <?php $__env->stopSection(); ?>
...
} elseif ($_instance->childHasBeenRendered('Y9JGIlt')) {
    $componentId = $_instance->getRenderedChildComponentId('Y9JGIlt');
    $componentTag = $_instance->getRenderedChildComponentTagName('Y9JGIlt');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('Y9JGIlt');
} else {
    $response = \Livewire\Livewire::mount('frontend.display-category');
    $html = $response->html();
    $_instance->logRenderedChild('Y9JGIlt', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
</section>
...
} elseif ($_instance->childHasBeenRendered('WjXsI9l')) {
    $componentId = $_instance->getRenderedChildComponentId('WjXsI9l');
    $componentTag = $_instance->getRenderedChildComponentTagName('WjXsI9l');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('WjXsI9l');
} else {
    $response = \Livewire\Livewire::mount('frontend.new-arrivals');
    $html = $response->html();
    $_instance->logRenderedChild('WjXsI9l', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                </div>
...
} elseif ($_instance->childHasBeenRendered('yfHzx3J')) {
    $componentId = $_instance->getRenderedChildComponentId('yfHzx3J');
    $componentTag = $_instance->getRenderedChildComponentTagName('yfHzx3J');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('yfHzx3J');
} else {
    $response = \Livewire\Livewire::mount('frontend.featured-product');
    $html = $response->html();
    $_instance->logRenderedChild('yfHzx3J', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
    </div>
