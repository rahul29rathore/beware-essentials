...
@section('meta_keywords'){{ $product->meta_keywords }}@endsection
@section('other'){!! $product->other !!}@endsection
<div>
                        ...
                        <div class="col-lg-5" data-aos="fade-right" wire:ignore.self data-aos-delay="200">
                            <div class="easyzoom easyzoom--overlay w-100 border">
                                <a href="{{ $product->product_image_url }}">
                                    <img src="{{ $product->product_image_url }}" class="main-p-img w-100 h-100"
                                        alt="{{ $product->name }}">
                                </a>
                            </div>
                        </div>
                            ...
                            <div class="summary entry-summary">
                                ...
                                <span class="price">
                                    ...
                                    <ins class="d-none"><span class="woocommerce-Price-amount amount"><span
                                            ...
                                            </span>{{ number_format($product->price, 2, '.', ',') }}</span></ins>
                                </span>
