            ...
            <div class="ec-vendor-main-img">
                <div class="avatar-upload">
                    <div class="avatar-edit">
                        <input type="file" wire:model="product.image" id="imageUpload" class="ec-image-upload"
                            accept=".png, .jpg, .jpeg">
                ...
                <div class="thumb-upload-set colo-md-12">
                    <div class="thumb-upload">
                        <div class="thumb-edit">
                            <input wire:model="product.images.0" type="file" id="thumbUpload01" class="ec-image-upload"
                                accept=".png, .jpg, .jpeg">
                            <label for="imageUpload">
                                <img src="{{ asset('admin-assets/assets/img/icons/edit.svg') }}"
                            ...
                            <div class="image-thumb-preview">
                                @if (isset($product['images'][0]))
                                    <img src="{{ $product['images'][0]->temporaryUrl() }}"
                                        class="image-thumb-preview ec-image-preview" alt="edit">
                                @elseif(isset($product['product_images'][0]))
                                    <img src="{{ asset('storage/' . $product['product_images'][0]['collection_name'] . '/' . $product['product_images'][0]['id'] . '/' . $product['product_images'][0]['file_name']) }}"
                                        class="image-thumb-preview ec-image-preview" alt="edit">
                                @else
                    ...
                    <div class="thumb-upload">
                        <div class="thumb-edit">
                            <input wire:model="product.images.1" type="file" id="thumbUpload02" class="ec-image-upload"
                                accept=".png, .jpg, .jpeg">
                            <label for="imageUpload">
                                <img src="{{ asset('admin-assets/assets/img/icons/edit.svg') }}"
                                    class="svg_img header_svg" alt="edit">
                        ...
                        <div class="thumb-preview ec-preview">
                            <div class="image-thumb-preview">
                                @if (isset($product['images'][1]))
                                    <img src="{{ $product['images'][1]->temporaryUrl() }}"
                                        class="image-thumb-preview ec-image-preview" alt="edit">
                                @elseif(isset($product['product_images'][1]))
                                    <img src="{{ asset('storage/' . $product['product_images'][1]['collection_name'] . '/' . $product['product_images'][1]['id'] . '/' . $product['product_images'][1]['file_name']) }}"
                                        class="image-thumb-preview ec-image-preview" alt="edit">
                                @else
                                    <img class="image-thumb-preview ec-image-preview"
                                        src="{{ asset('admin-assets/assets/img/products/vender-upload-thumb-preview.jpg') }}"
                        ...
                        <div class="thumb-preview ec-preview">
                            <div class="image-thumb-preview">
                                @if (isset($product['images'][2]))
                                    <img src="{{ $product['images'][2]->temporaryUrl() }}"
                                        class="image-thumb-preview ec-image-preview" alt="edit">
                                @elseif(isset($product['product_images'][2]))
                                    <img src="{{ asset('storage/' . $product['product_images'][2]['collection_name'] . '/' . $product['product_images'][2]['id'] . '/' . $product['product_images'][2]['file_name']) }}"
                                        class="image-thumb-preview ec-image-preview" alt="edit">
                                @else
                                    <img class="image-thumb-preview ec-image-preview"
                                        src="{{ asset('admin-assets/assets/img/products/vender-upload-thumb-preview.jpg') }}"
				...
				<div class="form-checkbox-box">
				 ...
				 <div class="form-check form-check-inline"><input type="checkbox" name="size1" value="size"><label>XXL</label></div>
                    ...
                    <div class="col-md-6 mb-5">
                        ...
                        <input wire:model.lazy="product.price" type="text" class="form-control decimal2number"
                            id="price1">
                        @error('product.price')
                            <span class="text-danger">{{ $message }} </span>
                        @enderror
				   ...
				   " wire:model.debounce.2000ms="product.detail">
                    ...
                    <div class="col-md-12 mb-5">
                        <label class="form-label">Product Tags <span>( Type and make <b>','</b> to separate tags
                                )</span></label>
                    ...
                    <div wire:ignore class="col-md-12 mb-5">
                        <label class="form-label">Upload Brochure <br><span>( <i>File should be in '.pdf' format and
                                    less than 6MB</i> )</span></label>
                        <div class="d-flex">
                            <div class='file-input' x-data="{ isUploading: false, progress: 0 }"
                    ...
                    <div class="col-md-6 mb-5">
                        <div class="form-group">
                            ...
                            <input type="text" id="meta_title" class="form-control"
                                wire:model.lazy="product.meta_title">
                    ...
                    <div class="col-md-6 mb-3">
                        <div class="form-group">
                            ...
                            <textarea id="meta_description" class="form-control"
                                wire:model.lazy="product.meta_description" rows="3"></textarea>
                    ...
                    <div class="col-md-6 mb-3">
                        <div class="form-group">
                            ...
                            <textarea id="meta_keywords" class="form-control" wire:model.lazy="product.meta_keywords"
                                rows="3"></textarea>
                    ...
                    <div class="col-md-12 mb-5">
                        <div class="form-group">
                            ...
                            <textarea id="other" class="form-control" wire:model.lazy="product.other"
                                rows="3"></textarea>
                            @error('product.other')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                                ...
                                @foreach($product['product_specifications'] as $product_specification)
                                    <tr>
                                        <td class="p-0"><input type="text"
                                                wire:model="product.product_specifications.{{ $loop->index }}.attribute_name"
                                                class="form-control font-weight-600 m-0" placeholder="Enter Attributes">
                                        </td>
                                        <td class="p-0"><input type="text"
                                                wire:model="product.product_specifications.{{ $loop->index }}.attribute_value"
                                                class="form-control m-0" placeholder="Enter Value"></td>
                                        <td class="p-0" valign="middle" width="100"><a href="javascript:void(0)"
                                                wire:click="removeSpecification({{ $loop->index }})"><i
                                                    class="mdi mdi-minus"> Remove </i></a></td>

                                    </tr>
                                @endforeach
                                <tr>
                                    <td class="p-0"><input type="text" wire:model="attribute_name"
                                            class="form-control font-weight-600 m-0" placeholder="Enter Attributes">
                                    </td>
                                    <td class="p-0"><input type="text" wire:model="attribute_value"
                                            class="form-control m-0" placeholder="Enter Value"></td>
                                    <td class="p-0" valign="middle" width="100"><a href="javascript:void(0)"
                                            wire:click="addSpecification()"><i class="mdi mdi-plus"> Add Specs</i></a>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
                    ...
                    <div class="col-md-12">
                        ...
                        @else
                            <button type="submit" class="btn btn-primary" wire:target='create'
                                wire:loading.class="btn-disable-processing" wire:loading.attr="disabled">
                                <i class="mdi mdi-content-save"></i> Submit &nbsp;
                                <span class="spinner-border spinner-border-sm" role="status" aria-hidden="true"
                                    wire:target='create' wire:loading></span>
                            </button>
                        @endif
                    </div>
                </form>
