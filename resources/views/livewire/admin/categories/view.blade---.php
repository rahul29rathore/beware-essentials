			  ...
			  <div class="ec-cat-form">
				 ...
				 @endif
					...
					<div class="form-group row">
					   <!-- <label class="col-12 col-form-label">Parent Category111</span></label> -->
					  <!--  <div class="col-12">
							...
							<div class="ec-vendor-main-img">
								<div class="avatar-upload">
									<div class="avatar-edit">
										<input type="file" wire:model="category.image" id="imageUpload" class="ec-image-upload" accept=".png, .jpg, .jpeg">
									...
									<div class="avatar-preview ec-preview">
										<div class="imagePreview ec-div-preview">
											...
											<img class="ec-image-preview" src="{{ $category['image']->temporaryUrl() }}" alt="edit">
											...
											<img class="ec-image-preview" src="{{ $category['category_image_url'] }}" alt="edit">


											@else

											<img class="ec-image-preview" src="{{ asset('admin-assets/assets/img/products/category-upload-preview.jpg') }}" alt="edit">
											@endif
					...
					@endif
					<div class="form-group row">
					   <label for="text" class="col-12 col-form-label">Name <span class="text-danger">*</span></label>
					   <div class="col-12">
					...
					<div class="form-group row">
					   <label class="col-12 col-form-label">Short Description</label>
					    <div class="col-12">
							<textarea wire:model="category.short_description" cols="40" rows="2" class="form-control"></textarea>
					...
					@if($this->template == 'sub-category')
					<div class="form-group row">
					   <label for="parent-category" class="col-12 col-form-label">Parent Category <span class="text-danger">*</span></label>
					   <div class="col-12">
						  <select id="parent-category" wire:model="category.parent_id"  name="parent-category" class="custom-select">
						...
						<table class="table dataTable no-footer" style="width:100%">
							<thead>
							   <tr>
								  ...
								  @if($this->template == 'main-category')
								  <th class="">Sub Categories</th>
							      @else
								  <th class="">Parent Categories</th>
							   ...
							   <tr>
								  ...
								  <td>
									...
									<span class="ec-sub-cat-list">
										<span class="ec-sub-cat-count" title="Total Sub Categories">{{ @$category->categories->count() }}</span> 
								  ...
								  <td>
									...
									<span class="ec-sub-cat-list">
										<!-- <span class="ec-sub-cat-count" title="Total Parent Categories">{{ $category->parent->count() }}</span>  -->
								  ...
								  <td>
                                    ...
                                    onclick="loadDetailModal(this,'{{ route('admin.categories.show', $category->slug ) }}')" class="btn btn-outline-success">Info</a> <button type="button" class="btn btn-outline-success dropdown-toggle dropdown-toggle-split" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false" data-display="static"><span class="sr-only">Info</span></button>
										<div class="dropdown-menu">
											<a class="dropdown-item" href="#" wire:click="edit({{ $category->id }})">Edit</a> 
											<a class="dropdown-item" href="javascript:void(0)" wire:click="setSelected({{ $category->id }})">Delete</a>
									 </div>
								  </td>
							   </tr>
							   @endforeach
