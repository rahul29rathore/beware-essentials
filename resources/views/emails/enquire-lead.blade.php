...
<table cellpadding="0" cellspacing="0" width="90%" style="background:#fff;border-radius:10px;border-color:#d8d8d8;">
	<tr>
		<td style="padding:0 15px;">
			<p style="margin:0;padding:0;background:url(img/order.png);background-size:cover;">Dear Team,<br><br> We have received lead from {{ env('APP_NAME') }}. Please check the following details.</p>
			
			<p style="font-size:18px;font-weight:600;margin-bottom:20px;"><u>Lead Information</u></p>
			<table cellpadding="0" border="1" cellspacing="0" width="100%" style="border-collapse:collapse;border-color:#d8d8d8;margin-bottom:15px;">
                ...
                <tr>
					<th width="150" align="left" style="padding:5px 15px;background: #e1f6d6;">Product</th>
					<td style="padding:5px 15px">{{ $data['product'] ?? '' }}</td>
				</tr>
				
			</table>
			@if(!empty($data['message']))
			<p style="margin:0;font-size:18px;font-weight:600;margin-bottom:8px;"><u>Message</u></p>
