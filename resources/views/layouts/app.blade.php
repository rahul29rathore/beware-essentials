...
<head>
	...
	<title>@yield('title', 'CCTV Security Products | Beware')</title>
	...
	<meta property="og:description" content="An Indian Turnkey Infrastructure company have worked to be the end-to-end service provider for all Industrial Infrastructural needs" />
	<meta property="og:image" content="{{ asset('assets/images/12.png') }}" />
	<meta property="og:url" content="https://www.beware-essentials.com" />
	...
	<script>
		...
		})(window, document, 'script', 'dataLayer', 'GTM-WD4FKPN');
	</script>
	@endenv
