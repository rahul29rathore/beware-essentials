	...
	<div id="sidebar" class="sidebar ec-sidebar-footer">
		<div class="ec-brand">
			<a href="/" title="Beware Essential">
				<img src="{{ asset('assets/images/admin-logo.png') }}" alt="">
			</a>
		</div>
		<div class="ec-navigation" data-simplebar="">
			<ul class="nav sidebar-inner" id="sidebar-menu">
				<li class="active"><a class="sidenav-item-link" href="{{ route('admin.dashboard') }}"><i
				...
				<li class="has-sub"><a class="sidenav-item-link" href="javascript:void(0)"><i class="mdi mdi-dns-outline"></i> <span class="nav-text">Categories</span> <b class="caret"></b></a>
					<div class="collapse">
						<ul class="sub-menu" id="categorys" data-parent="#sidebar-menu">
							...
							<li><a class="sidenav-item-link" href="{{ route('admin.categories.sub-categories.index') }}"><span class="nav-text">Sub Categories</span></a></li>
						</ul>
					</div>
				</li>
				<li class="has-sub">
					...
					<div class="collapse">
						<ul class="sub-menu" id="products" data-parent="#sidebar-menu">
							<!-- <li>
								<a class="sidenav-item-link" href="{{ route('admin.product-types.index') }}">
				...
				<li class="has-sub">
					...
					<div class="collapse">
						<ul class="sub-menu" id="products" data-parent="#sidebar-menu">
							<li>
								<a class="sidenav-item-link" href="{{ route('admin.product-leads.index') }}">
									<span class="nav-text">Product Leads</span>
								</a>
							</li>
							<li>
								<a class="sidenav-item-link" href="{{ route('admin.contact-us-leads.index') }}">
									<span class="nav-text">Contact US leads</span>
								</a>
							</li>
							<li>
								<a class="sidenav-item-link" href="{{ route('admin.distributer') }}">
									<span class="nav-text">Distributer leads</span>
								</a>
							</li>
							<li>
								<a class="sidenav-item-link" href="{{ route('admin.carrers') }}">
