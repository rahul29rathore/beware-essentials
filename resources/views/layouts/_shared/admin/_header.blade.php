		...
		<div class="navbar-right">
			<ul class="nav navbar-nav">
				<li class="dropdown user-menu"><button class="dropdown-toggle nav-link ec-drop"
						data-bs-toggle="dropdown" aria-expanded="false"><img src="{{ asset('admin-assets/assets/img/user/u-xl-9.jpg') }}"
							class="user-image" alt="User Image"></button>
					<ul class="dropdown-menu dropdown-menu-right ec-dropdown-menu">
						<li class="dropdown-header"><img src="{{ asset('admin-assets/assets/img/user/u-xl-9.jpg') }}" class="img-circle"
								alt="User Image">
						...
						<li class="dropdown-footer"><a href="{{ route('logout') }}"
									...
									<ul class="list-unstyled" data-simplebar="" style="height:360px">
										<li><a href="javscript:void(0)"
												...
												<div class="position-relative mr-3"><img
														class="rounded-circle" src="{{ asset('admin-assets/assets/img/user/u2.jpg') }}"
										...
										<li><a href="javscript:void(0)"
												...
												<div class="position-relative mr-3"><img
														class="rounded-circle" src="{{ asset('admin-assets/assets/img/user/u1.jpg') }}"
										...
										<li><a href="javscript:void(0)"
												class="media media-message media-notification">
												<div class="position-relative mr-3"><img
														class="rounded-circle" src="{{ asset('admin-assets/assets/img/user/u5.jpg') }}"
														alt="Image"> <span class="status away"></span></div>
												<div class="media-body d-flex justify-content-between">
													<div class="message-contents">
								...
								<div class="tab-pane fade" id="profile2" role="tabpanel">
									<ul class="list-unstyled" data-simplebar="" style="height:360px">
										<li><a href="javscript:void(0)"
												class="media media-message media-notification">
												<div class="position-relative mr-3"><img
														class="rounded-circle" src="{{ asset('admin-assets/assets/img/user/u6.jpg') }}"
														alt="Image"> <span class="status away"></span></div>
												<div class="media-body d-flex justify-content-between">
													<div class="message-contents">
										...
										<li><a href="javscript:void(0)"
												class="media media-message media-notification">
												<div class="position-relative mr-3"><img
														class="rounded-circle" src="{{ asset('admin-assets/assets/img/user/u7.jpg') }}"
														alt="Image"> <span class="status away"></span></div>
												<div class="media-body d-flex justify-content-between">
													<div class="message-contents">
