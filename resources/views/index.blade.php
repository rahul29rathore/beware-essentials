...
<!--------- Facebook Meta Tags ------------->
<meta property="og:title" content="Beware Essentials | CCTV, Biometric & Security Solutions" />
<meta property="og:description" content="Protect your home and business with CCTV cameras, biometric systems, and access control solutions by Beware Essentials." />
<meta property="og:url" content="https://beware-essentials.com/" />
<meta property="og:image" content="https://beware-essentials.com/assets/images/revslider/banner-4.jpg">
<meta property="og:image:secure_url" content="https://beware-essentials.com/assets/images/revslider/banner-4.jpg">
<meta property="og:image:width" content="1100" />
<meta property="og:image:height" content="228" />

<!--------- Twitter Meta Tags -------------->
<meta name="twitter:title" content="Beware Essentials | CCTV, Biometric & Security Solutions" />
<meta name="twitter:description" content="Protect your home and business with CCTV cameras, biometric systems, and access control solutions by Beware Essentials." />
<meta name="twitter:card" content="Protect your home and business with CCTV cameras, biometric systems, and access control solutions by Beware Essentials.">
<meta name="twitter:site" content="https://beware-essentials.com/">
<meta name="twitter:image" content="https://beware-essentials.com/assets/images/revslider/banner-4.jpg">
...
<section class="p-0 mb-5">
    <div class="container-fluid">
        <div class="slider main-slider">
            <div class="item">
<<<<<<< HEAD
                <img src="{{ asset('assets/images/revslider/banner-4.jpg') }}" alt="CCTV" class="w-100">
            </div>
            <div class="item">
                <img src="{{ asset('assets/images/revslider/banner-5.jpg') }}" alt="Biometric" class="w-100">
            </div>
            <div class="item">
                <img src="{{ asset('assets/images/revslider/banner-6.jpg') }}" alt="CCTV cameras" class="w-100">
            </div>
            <div class="item">
                <img src="{{ asset('assets/images/revslider/banner-1.jpg') }}" alt="Biometric & Security Solutions" class="w-100">
            </div>
            <div class="item">
...
=======
                <img src="{{ asset('assets/images/revslider/banner-4.jpg') }}" class="w-100">
            </div>
            <div class="item">
                <img src="{{ asset('assets/images/revslider/banner-5.jpg') }}" class="w-100">
            </div>
            <div class="item">
                <img src="{{ asset('assets/images/revslider/banner-6.jpg') }}" class="w-100">
            </div>
            <div class="item">
                <img src="{{ asset('assets/images/revslider/banner-1.jpg') }}" class="w-100">
            </div>
            <div class="item">
                <img src="{{ asset('assets/images/revslider/banner-2.jpg') }}" class="w-100">
            </div>
            <div class="item">
                <img src="{{ asset('assets/images/revslider/banner-3.jpg') }}" class="w-100">
>>>>>>> Rudraa
            </div>
        </div>
    </div>
...
<section class="section-category">
    @livewire('frontend.display-category')
</section>
...
>>>>>>> Rudraa
                <div class="col-lg-12">
                    ...
                    @livewire('frontend.new-arrivals')
                </div>
            </div!-->
<<<<<<< HEAD
    </div>
                ...
                <div class="dt-sc-image-caption" data-aos="fade-left">
                    <div class="dt-sc-image-content">
                        <div class="dt-sc-image-title">
                            <h1 style="font-size: 18px;">Being alert for you always!</h1>
                        ...
                        <p><a href="{{ route('products') }}" target="_self" title=""
    ...
    <div class="container">
        <div class="row">
            <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12" data-aos="fade-down" data-aos-delay="200">
                <img class="baby-monitoring" src="{{ asset('assets/images/landing/baby-monitoring.png') }}"
            ...
            <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12">
                <div class="main-content pt-lg-5" data-aos="fade-left" data-aos-delay="200">
                    ...
                    {{-- <p>Baby Monitoring Camera with Motion Detection & Sensor Integration</p> --}}
                    <div class="row text-white">
                        <div class="col-lg-6">
                            <ul>
                                <li class="d-flex my-2"><img src="{{ asset('assets/images/icons/motion-tracking.png') }}" width="48" class="mr-3"> Motion Tracking System</li>
                                <li class="d-flex my-2"><img src="{{ asset('assets/images/icons/speaker-microphone.png') }}" width="48" class="mr-3"> Speaker & Microphone</li>
                                <li class="d-flex my-2"><img src="{{ asset('assets/images/icons/day-night-vision.png') }}" width="48" class="mr-3"> Night Vision Upto 5-10 Mtr.</li>
                            </ul>
                        </div>
                        <div class="col-lg-6">
                            <ul>
                                <li class="d-flex my-2"><img src="{{ asset('assets/images/icons/sd-card.png') }}" width="48" class="mr-3"> MicroSD Support Upto 128GB</li>
                                <li class="d-flex my-2"><img src="{{ asset('assets/images/icons/mobile-app.png') }}" width="48" class="mr-3"> Free App for Smart Phone</li>
                                <li class="d-flex my-2"><img src="{{ asset('assets/images/icons/plug-play.png') }}" width="48" class="mr-3"> P2P, Plug & Play, Setting Free</li>
                            </ul>
                        </div>
                    </div>
                    <a href="{{ route('page', 'contact-us') }}" class="dt-sc-button medium text-white bg-theme-red mt-4">Buy Now</a>
                </div>
            </div>
            <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12" data-aos="fade-right" data-aos-delay="200">
                ...
                <div class="slider baby-monitoring-features">
                    <div><img class="img-fluid" src="{{ asset('assets/images/landing/feature-1.png') }}" alt="feature-1" /></div>
                    <div><img class="img-fluid" src="{{ asset('assets/images/landing/feature-2.png') }}" alt="feature-1" /></div>
                    <div><img class="img-fluid" src="{{ asset('assets/images/landing/feature-3.png') }}" alt="feature-1" /></div>
                    <div><img class="img-fluid" src="{{ asset('assets/images/landing/feature-4.png') }}" alt="feature-1" /></div>
                    <div><img class="img-fluid" src="{{ asset('assets/images/landing/feature-5.png') }}" alt="feature-1" /></div>
                    <div><img class="img-fluid" src="{{ asset('assets/images/landing/feature-6.png') }}" alt="feature-1" /></div>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="col-lg-6 row m-0 p-0">
                    <div class="col-lg-6" data-aos="zoom-in" data-aos-delay="200">
                        <div class="box-holder mb-4">
                            ...
                            <img src="{{ asset('assets/images/icons/pan-india.png') }}" class="first-img blend-darken">
                    ...
                    <div class="col-lg-6" data-aos="zoom-in" data-aos-delay="300">
                        <div class="box-holder mb-4 bg-transparent">
                            ...
                            <img src="{{ asset('assets/images/icons/consultation.png') }}"
                    ...
                    <div class="col-lg-6" data-aos="zoom-in" data-aos-delay="400">
                        <div class="box-holder mb-4 bg-transparent">
                            ...
                            <img src="{{ asset('assets/images/icons/maintenance.png') }}" class="first-img blend-darken">
                    ...
                    <div class="col-lg-6" data-aos="zoom-in" data-aos-delay="500">
                        <div class="box-holder mb-4">
                            ...
                            <img src="{{ asset('assets/images/icons/quick-installation.png') }}"
                                class="first-img blend-darken">
                            {{-- <img src="{{asset('assets/images/services/img-3.png')}}" class="second-img blend-darken"> --}}
                        </div>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3" data-aos="fade-down" data-aos-delay="200">
                                <a class="video-thumb"
                                    ...
                                    <img src="{{ asset('assets/images/landing/video-thumb-1.jpg') }}">
                                    <img src="{{ asset('assets/images/landing/play-button.png') }}" class="btn-play">
                                </a>
                            </div>
                            <div class="col-md-6 mb-3" data-aos="fade-up" data-aos-delay="200">
                                <a class="video-thumb"
                                    ...
                                    data-toggle="modal" data-target="#video-popup">
                                    <img src="{{ asset('assets/images/landing/video-thumb-2.jpg') }}">
                                    <img src="{{ asset('assets/images/landing/play-button.png') }}" class="btn-play">
                                </a>
=======
    <section class="section-gap">
    ...
    <div class="container">
        ...
        <div class="row justify-content-center">
            <div class="col-lg-6">
                <div class="row">
                    <div class="col-lg-5">
                        <img src="{{ asset('assets/images/11.png') }}" class="img-fluid br-20" alt="">
                    </div>
                    <div class="col-lg-7">
        ...
        <div class="container">
            ...
            <div class="row justify-content-center">
                ...
                <div class="col-lg-6">
                    <div class="row">
                        <div class="col-lg-5">
                            <img src="{{ asset('assets/images/12.png') }}" class="img-fluid br-20" alt="">
                        </div>
                        <div class="col-lg-7">
            ...
            <div class="row">
                ...
                <div class="col-md-12 m-auto">
                    <div id="testimonial-slider" class="slider" data-aos="fade-down" data-aos-delay="200">
                        ...
                        <div class="testimonial">
                            <div class="pic">
                                <img src="{{ asset('assets/images/testimonial/img-4.jpg') }}" alt="">
                            </div>
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-9 mx-auto text-center mb-4">
                <img src="{{ asset('assets/images/img1-1.png') }}">
                <div class="dt-sc-title script-with-sub-title">
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="slider blog-slider w-100">
                    @foreach(@Helper::showblogs() as $blog)
                    <div class="px-3">
                        <a href="{{ route('blog-detail',$blog->id) }}" class="blog-item">
                            @if (isset($blog['image']))
                            ...
                            <div class="blog-content">
                                <h4>{{$blog->title}}</h4>
                                <p>Posted on {{ $blog->created_at->format('j M Y') }}</p>
                            </div>
                        </a>
                    </div>
                    @endforeach
        ...
        <div class="row">
            ...
            <div class="col-md-12 mb-5">
                <div id="client-slider-1" class="slider">
                    <div><img src="{{ asset('assets/images/clients/client-1.jpg') }}" class="img-fluid"></div>
                    <div><img src="{{ asset('assets/images/clients/client-2.jpg') }}" class="img-fluid"></div>
                    <div><img src="{{ asset('assets/images/clients/client-3.jpg') }}" class="img-fluid"></div>
                    <div><img src="{{ asset('assets/images/clients/client-4.jpg') }}" class="img-fluid"></div>
                    <div><img src="{{ asset('assets/images/clients/client-5.jpg') }}" class="img-fluid"></div>
                    <div><img src="{{ asset('assets/images/clients/client-6.jpg') }}" class="img-fluid"></div>
                    <div><img src="{{ asset('assets/images/clients/client-7.jpg') }}" class="img-fluid"></div>
                    <div><img src="{{ asset('assets/images/clients/client-8.jpg') }}" class="img-fluid"></div>
                    <div><img src="{{ asset('assets/images/clients/client-9.jpg') }}" class="img-fluid"></div>
                    <div><img src="{{ asset('assets/images/clients/client-10.jpg') }}" class="img-fluid"></div>
                </div>
            </div>
            <div class="col-md-12">
                <div id="client-slider-2" class="slider">
                    <div><img src="{{ asset('assets/images/clients/client-11.jpg') }}" class="img-fluid"></div>
                    <div><img src="{{ asset('assets/images/clients/client-12.jpg') }}" class="img-fluid"></div>
                    <div><img src="{{ asset('assets/images/clients/client-13.jpg') }}" class="img-fluid"></div>
                    <div><img src="{{ asset('assets/images/clients/client-14.jpg') }}" class="img-fluid"></div>
                    <div><img src="{{ asset('assets/images/clients/client-15.jpg') }}" class="img-fluid"></div>
                    <div><img src="{{ asset('assets/images/clients/client-16.jpg') }}" class="img-fluid"></div>
                    <div><img src="{{ asset('assets/images/clients/client-17.jpg') }}" class="img-fluid"></div>
                    <div><img src="{{ asset('assets/images/clients/client-18.jpg') }}" class="img-fluid"></div>
                    <div><img src="{{ asset('assets/images/clients/client-19.jpg') }}" class="img-fluid"></div>
                    <div><img src="{{ asset('assets/images/clients/client-20.jpg') }}" class="img-fluid"></div>
                </div>
            </div>
        </div>
    </div>
